...
public class AnalizadorLexico {
    ...
    public static void showWindows() {
        String[] opciones = {"Archivo", "Lista de tokens","Analizador lexico", "Salir"};
        int opcion = 0;
        while (opcion == 0) {
            ...
            while(opcion ==2){
                opcion = JOptionPane.showOptionDialog(null, hagaAnalisis().toString(),
                        "Analizador Léxico", 0, JOptionPane.QUESTION_MESSAGE, null, opciones, "");
            }
        }
    }
    /*
          En este método se incluye el nuevo código
          Se debe dejar el retorno de la cadena vacía
     */
    public static String hagaAnalisis(){
